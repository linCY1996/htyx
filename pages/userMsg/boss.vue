	...
	<view class="" style="background: url(http://47.108.66.16:8088/static/project/dolphin/static/images/beijing02.png) no-repeat;background-size: cover;height: 700px;width: 100%;padding-top: 2%;font-family: Alibaba PuHuiTi;">
		...
		<form @submit="submitData">
			...
			<view class="normal-color" style="margin-left: 10%;margin-right: 10%;">
				...
				<view class="setFlex title-base">
					<view class="" style="flex-grow: 1;">
						<input type="text" name='address' placeholder="详细地址" maxlength="200" placeholder-style="color: #cccccc" value="" style="background-color:#f3f3f3;padding-left: 10px;height: 30px;border-radius: 6px"/>
					</view>
				</view>
